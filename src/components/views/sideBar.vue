...
const menuItems = [
  { label: 'Accueil', key: 'home', path: '/dashboard' },
  { label: 'Rechargeurs', key: 'rechargeurs', path: '/dashboard/rechargeur' },
  { label: 'Trottinettes', key: 'trottinettes', path: '/dashboard/trottinette' },
  { label: 'Paramètres', key: 'settings', path: '/dashboard/settings' }
]
